...
The chart on the right is a real `matplotlib` PNG — line plot with markers, a fitted trendline, and **two highlighted regions**: a yellow band for the starting momentum phase and an orange dot annotating the inflection point at Week 6.
