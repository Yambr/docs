...
Open **Workspace → Models**, pick any enabled model, and start a chat. Each sign-in sees only the models enabled on your account / plan. If you need a model that isn't listed, [open an issue](https://github.com/Yambr/open-computer-use/issues) or ping us on [Telegram](https://t.me/yambrcom).
