...
<CardGroup cols={2}>
  <Card
    ...
    href="/quickstart"
  >
    Get an API key at [app.yambr.com](https://app.yambr.com/), point any OpenAI-compatible client at [api.yambr.com](https://api.yambr.com), or just open [chat.yambr.com](https://chat.yambr.com/) and start chatting. No servers to run.
  </Card>
  <Card
    title="Self-hosted"
    icon="server"
...
<Steps>
  ...
  <Step title="Grab an API key (optional)">
    Want to drive it from code? Get a key at [app.yambr.com](https://app.yambr.com/) and point your OpenAI SDK at `https://api.yambr.com`. See [Yambr LiteLLM gateway](/platform/litellm).
  </Step>
</Steps>
