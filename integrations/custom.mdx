...
For managed Yambr, the raw MCP endpoint isn't public — go through [api.yambr.com](/platform/litellm) instead. Any OpenAI-compatible tool-enabled chat completion on that endpoint has Computer Use tools available automatically.
